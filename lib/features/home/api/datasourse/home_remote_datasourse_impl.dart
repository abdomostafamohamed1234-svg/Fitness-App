...
class HomeRemoteDataSourceImpl implements HomeRemoteDataSourceContract {
  ...
  @override
  Future<Result<ProfileResponseDto>> getProfileData() async {
    try {
      final ProfileResponseDto response =
          await _homeApiClient.getProfileData();
      return Success<ProfileResponseDto>(data: response);
    } on Exception catch (e) {
      return Error<ProfileResponseDto>(exception: e);
    }
  }
}