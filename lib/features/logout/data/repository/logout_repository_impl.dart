...
import 'package:flowery/features/logout/api/api_client/logout_api_client.dart';
...
class LogoutRepositoryImpl implements LogoutRepository {
  ...
  Future<Result<void>> logout() async {
    try {
      ...
      // امسحي التوكين محليًا سواء نجح الـ API أو حتى لو فشل (اختياري)،
      // هنا بنمسحه بس بعد نجاح الريكوست عشان نتأكد إن السيرفر عرف
      // إن الجلسة خلصت.
